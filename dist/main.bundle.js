...
eval("const restEndPoint = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/xHcNAgk6UkMi3fEdct8S/scores'\n\n\nconst refresh = document.getElementById('refresh')\nrefresh.addEventListener('click', () => {\n\tfetch(restEndPoint)\n\t\t.then((response) => response.json())\n\t\t.then((data) => {\n\t\t\tconsole.log(data)\n\t\t})})\n\n//# sourceURL=webpack://leaderboard/./src/modules/refreshScore.js?");
